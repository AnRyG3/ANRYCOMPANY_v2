...
SRC_DIR = ROOT / "reel_assets" / "xray_small_crack_sample_frames"
OUT_DIR = ROOT / "reel_assets" / "xray_small_crack_telop_frames_v2"
...
FRAMES = [
    ("frame_01_patient_wrist_sample.png", "frame_01_telop.png", ["骨折なしでも", "痛みが続くことも"], 1240),
    ("frame_02_patient_worried_sample.png", "frame_02_telop.png", ["不安になる方は", "少なくありません"], 1240),
    ("frame_03_rt_monitor_sample.png", "frame_03_telop.png", ["小さなヒビは", "写りにくいことも"], 1240),
    ("frame_04_rt_overlap_xray_sample.png", "frame_04_telop.png", ["骨の重なりで", "見えにくい場合も"], 1240),
    ("frame_05_rt_xray_room_sample.png", "frame_05_telop.png", ["受傷直後は", "線が細いことも"], 1240),
    ("frame_06_rt_monitor_sample.png", "frame_06_telop.png", ["X線写真の", "検査の特性です"], 210),
    ("frame_07_followup_rt_patient_sample.png", "frame_07_telop.png", ["痛みが続く時は", "再検査や詳しい検査へ"], 210),
    ("frame_08_patient_relieved_sample.png", "frame_08_telop.png", ["見逃しとは限らず", "判断しきれないことも"], 1240),
    ("frame_09_doctor_patient_sample.png", "frame_09_telop.png", ["痛みが続く時は", "そのまま伝えてOK"], 210),
    ("frame_10_rt_reassuring_sample.png", "frame_10_telop.png", ["確認できる仕組みが", "ちゃんとあります"], 1240),
    ("frame_11_save_button_sample.png", "frame_11_telop.png", ["気になった方は", "保存してください"], 820),
    ("frame_12_rt_bow_sample.png", "frame_12_telop.png", ["診療放射線技師の発信", "フォローで応援お願いします"], 820),
]
...
def draw_telop(img: Image.Image, lines: list[str], y: int) -> Image.Image:
    ...
    fnt, gap = fit_font(draw, lines, int(W * 0.78), 168)
