...
ASSET_DIR = ROOT / "reel_assets" / "xray_visible_invisible_20260814"
FRAME_DIR = ROOT / "reel_assets" / "xray_visible_invisible_telop_frames_20260814"
AUDIO_DIR = ASSET_DIR / "audio"
WORK_DIR = ASSET_DIR / "_video_work"
VIDEO_DIR = ASSET_DIR / "video"
MANIFEST = ASSET_DIR / "video_manifest_20260814.json"
...
OUT = VIDEO_DIR / "レントゲンに写るもの写らないもの_20260814.mp4"
...
DISPLAY_NARRATION = [
    "「レントゲンで異常なし。でも痛い」そんな時に知っておきたいこと。",
    "レントゲンに写るものと写りにくいもの、意外と知られていません。",
    "骨は写るのに、痛みの原因が分からないままだと、モヤモヤが残る。その気持ち、おかしくありません。",
    "実は、レントゲンは骨の状態を映す検査で、すべての痛みの原因を映し出せるわけではありません。",
    "骨折やズレなど骨に関わる変化は写りますが、筋肉や神経、炎症などは写りにくい場合があります。",
    "そのため、症状や診察内容によっては、CTやMRIなどで確認することもあります。",
    "それでも、「意味がなかったのでは」と感じることもあるかもしれません。",
    "レントゲンで異常がないと分かることも、原因を絞り込むための大切な情報です。",
    "気になることがあれば、遠慮なく伝えていただいて大丈夫です。",
    "検査後に不安になった時のために、「写るもの・写らないもの」は保存しておいてください。検査のことをもっと知りたい方は、フォローしてお待ちください。",
]

# Voice-only text avoids symbols or roman letters that can cause odd readings.
VOICE_TEXT = [
    "レントゲンで異常なし。でも痛い。そんな時に知っておきたいこと。",
    "レントゲンに写るものと、写りにくいもの。意外と知られていません。",
    "骨は写るのに、痛みの原因が分からないままだと、モヤモヤが残る。その気持ち、おかしくありません。",
    "実は、レントゲンは骨の状態を映す検査で、すべての痛みの原因を映し出せるわけではありません。",
    "骨折やズレなど、骨に関わる変化は写りますが、筋肉や神経、炎症などは、写りにくい場合があります。",
    "そのため、症状や診察内容によっては、シーティーやエムアールアイなどで確認することもあります。",
    "それでも、意味がなかったのでは、と感じることもあるかもしれません。",
    "レントゲンで異常がないと分かることも、原因を絞り込むための大切な情報です。",
    "気になることがあれば、遠慮なく伝えていただいて大丈夫です。",
    "検査後に不安になった時のために、写るもの、写らないものは保存しておいてください。検査のことをもっと知りたいかたは、フォローしてお待ちください。",
]

MIN_DURATIONS = [4.0, 4.0, 6.4, 6.0, 6.5, 5.6, 4.7, 5.2, 4.4, 7.8]
