...
AUDIO_DIR = ASSET_DIR / "audio_20260619_v2"
WORK_DIR = ASSET_DIR / "_video_work_20260619_v2"
OUT_DIR = ASSET_DIR / "video_20260619_v2"
...
NARRATION = [
    ...
    "たとえば消化管に穴が開くと、空気がお腹の中に漏れることがあります。",
    "その空気は、胸部エックス線で見えることがあります。",
...
def main():
    ...
    missing_frames = [str(FRAME_DIR / f"frame_{i:02d}_text.png") for i in range(1, 13) if not (FRAME_DIR / f"frame_{i:02d}_text.png").exists()]
    if missing_frames:
    ...
    for idx, text in enumerate(NARRATION, start=1):
        ...
        pad_seconds = 0.28 if idx < 11 else 0.55
    ...
    final_video = OUT_DIR / "chest_xray_abdominal_pain_20260619_v2.mp4"
    run([
