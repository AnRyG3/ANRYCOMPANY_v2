...
BGM = ROOT / "01_ショート動画_リール_YouTubeShorts" / "インスタリール用" / "学び舎の風景.mp3"
OUT = ASSET_DIR / "エコー検査_何がわかるの.mp4"
FINAL_OUT = ROOT / "01_ショート動画_リール_YouTubeShorts" / "インスタ完成形" / "エコー検査　何がわかる.mp4"
...
NARRATION = [
    ...
    "動き。",
    "血流。",
    "部位によっては、しこりや、石などの確認にも、使われます。",
    "エコーにも、得意、不得意があります。",
    "空気や骨の奥は、見えにくいことがあります。",
    "必要に応じて、シーティーや、エムアールアイなどと、使い分けます。",
    "目的に合った検査が、選ばれています。",
    "検査前の不安を、安心に変える情報を、発信中。",
    "エコー検査の前に、見返せるように、保存してください。",
]
