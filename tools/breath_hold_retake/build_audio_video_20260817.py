...
ASSET_DIR = ROOT / "reel_assets" / "breath_hold_retake_20260817"
FRAME_DIR = ROOT / "reel_assets" / "breath_hold_retake_telop_frames_20260817"
AUDIO_DIR = ASSET_DIR / "audio"
WORK_DIR = ASSET_DIR / "_video_work"
VIDEO_DIR = ASSET_DIR / "video"
MANIFEST = ASSET_DIR / "video_manifest_20260817.json"
...
OUT = VIDEO_DIR / "息の止め方うまくできていなくても大丈夫_20260817.mp4"
...
DISPLAY_NARRATION = [
    "検査中に「もう少し吸ってください」と言われて、「自分のせいかな」と思った方へ。",
    "自分の息の止め方が悪かったのかと、申し訳なく感じてしまう。",
    "「もう一度」と言われるたびに、同じことを繰り返してしまったと気になってしまう。",
    "その気持ち、おかしくありません。",
    "実は、息の止め方には個人差があり、毎回同じように止められない方もたくさんいらっしゃいます。",
    "診療放射線技師は、撮影した画像を見ながら、肺の膨らみ具合を毎回過去の画像と比べて確認しています。",
    "過去の画像と比べて肺の膨らみ方が違うと判断した場合に、あらためて撮影をお願いすることがあります。",
    "それでも、「自分がうまくできていないのかな」と、気にしてしまうことがある。",
    "息の止め方の判断や確認は、診療放射線技師が行っているので、無理に完璧を目指さなくて大丈夫です。",
    "いつも通りに息を止めていただければ、それで十分です。次の検査前に見返せるように、保存しておいてください。",
    "こうした検査のリアルをこれからも届けます。フォローしておいてください。",
]

# Voice-only text uses kana for words that are easy to misread.
VOICE_TEXT = [
    "検査中に、もう少し吸ってください、と言われて、自分のせいかな、と思ったかたへ。",
    "自分の息の止めかたが悪かったのかと、申し訳なく感じてしまう。",
    "もう一度、と言われるたびに、同じことを繰り返してしまったと、気になってしまう。",
    "その気持ち、おかしくありません。",
    "実は、息の止めかたには個人差があり、毎回同じように止められないかたも、たくさんいらっしゃいます。",
    "診療放射線技師は、撮影した画像を見ながら、肺のふくらみ具合を、毎回、過去の画像と比べて確認しています。",
    "過去の画像と比べて、肺のふくらみかたが違うと判断した場合に、あらためて撮影をお願いすることがあります。",
    "それでも、自分がうまくできていないのかな、と、気にしてしまうことがある。",
    "息の止めかたの判断や確認は、診療放射線技師がおこなっているので、無理に完璧を目指さなくて大丈夫です。",
    "いつも通りに息を止めていただければ、それで十分です。次の検査前に見返せるように、保存しておいてください。",
    "こうした検査のリアルを、これからも届けます。フォローしておいてください。",
]

MIN_DURATIONS = [5.2, 4.8, 5.6, 2.8, 6.2, 7.4, 6.4, 4.8, 6.6, 6.8, 4.8]
...
def main() -> None:
    ...
    for index, text in enumerate(VOICE_TEXT, start=1):
        ...
        duration = max(MIN_DURATIONS[index - 1], wav_duration(voice) + 0.45)
