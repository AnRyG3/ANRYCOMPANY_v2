...
OUT = VIDEO_DIR / "pediatric_radiation_safety_telop_voice.mp4"
FINAL_OUT = (
    ROOT
    / "01_ショート動画_リール_YouTubeShorts"
    / "インスタ完成形"
...
NARRATION = [
    "小さい子に放射線を当てて、本当に大丈夫なんでしょうか。",
    "必要性を確認したうえで、お子さんに合わせた撮影をおこなっています。",
    "大人と同じ条件で撮影しているわけではありません。",
    "お子さんの体の大きさに合わせて、撮影条件を細かく調整しています。",
    "体が小さいお子さんには、必要以上に強くならないよう調整します。",
    "必要な範囲だけを、できるだけ短い時間で撮影します。",
    "一人ひとりのお子さんに合わせて、その都度確認しています。",
    "検査には理由があり、原因を早く見つけるために必要なことがあります。",
    "どのお子さんにも、その子に合わせた撮影をおこなっています。",
    "心配な時は、遠慮せず診療放射線技師に聞いてください。",
    "いざという時のために、スマートフォンに保存しておいてくださいね。",
    "診療放射線技師の発信です。フォローで応援お願いします。",
]

# Keep the early hook brisk, then give explanation frames enough breathing room.
MIN_DURATIONS = [4.2, 5.0, 4.2, 5.4, 5.2, 4.6, 4.8, 5.6, 4.8, 4.6, 4.6, 4.8]
