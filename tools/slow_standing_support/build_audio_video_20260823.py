...
ASSET_DIR = ROOT / "reel_assets" / "slow_standing_support_20260823"
FRAME_DIR = ROOT / "reel_assets" / "slow_standing_support_20260823_telop_frames"
AUDIO_DIR = ASSET_DIR / "audio"
WORK_DIR = ASSET_DIR / "_video_work"
VIDEO_DIR = ASSET_DIR / "video"
MANIFEST = ASSET_DIR / "video_manifest_20260823.json"
...
OUT = VIDEO_DIR / "立ち上がるのに時間がかかる時_急がなくて大丈夫です_20260823.mp4"
...
VOICE_SPEED = 1.2
BGM_VOLUME = "-25dB"
TAIL_PADDING_SECONDS = 0.14

FRAMES = [
    "telop_01_patient_slow_standing.png",
    "telop_02_rt_support_ready.png",
    "telop_03_waiting_worried.png",
    "telop_04_reassuring_voice.png",
    "telop_05_slow_pause.png",
    "telop_06_safely_standing.png",
    "telop_07_quiet_reflection.png",
    "telop_08_own_pace_reassurance.png",
    "telop_09_relief_after_standing.png",
    "telop_10_save_cta_phone.png",
]

DISPLAY_NARRATION = [
    "「立ち上がってください」と言われた時、すぐ動けなくて焦ったことはありませんか。",
    "支えが必要なときは、遠慮なく声をかけてください。必要に応じてサポートします。",
    "時間がかかってしまうことに、焦りを感じてしまう。みんなを待たせているのではと、気になってしまう。",
    "その気持ち、おかしくありません。",
    "実は、立ち上がる速さを無理に急ぐ必要はありません。",
    "ゆっくりで大丈夫です。安全に動いていただくことの方が大切です。",
    "それでも、「自分だけ時間がかかっている」と、感じてしまうことがある。",
    "動くペースには個人差があり、急ぐ必要はどなたにもありません。",
    "無理をせず、ご自身のペースで動いていただいて大丈夫です。",
    "次に検査で立ち上がる場面が不安な時に見返せるように、保存しておいてください。検査のリアルをこれからも届けます。フォローしてお待ちください。",
]
...
VOICE_TEXT = [
    ...
    "その気持ち、おかしくありません。",
    "実は、立ち上がる速さを無理に急ぐ必要はありません。",
    "ゆっくりで大丈夫です。安全に動いていただくことのほうが大切です。",
    "それでも、自分だけ時間がかかっていると、感じてしまうことがある。",
    "動くペースには個人差があり、急ぐ必要はどなたにもありません。",
    "無理をせず、ご自身のペースで動いていただいて大丈夫です。",
    "次に検査で立ち上がる場面が不安な時に見返せるように、保存しておいてください。検査のリアルをこれからも届けます。フォローしてお待ちください。",
]
