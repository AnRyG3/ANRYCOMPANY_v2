...
ASSET_DIR = ROOT / "reel_assets" / "xray_no_abnormality_pain_20260813"
FRAME_DIR = ROOT / "reel_assets" / "xray_no_abnormality_pain_telop_frames_20260813"
AUDIO_DIR = ASSET_DIR / "audio"
WORK_DIR = ASSET_DIR / "_video_work"
VIDEO_DIR = ASSET_DIR / "video"
MANIFEST = ASSET_DIR / "video_manifest_20260813.json"
...
OUT = VIDEO_DIR / "骨は折れていないのに痛い_20260813.mp4"
...
DISPLAY_NARRATION = [
    "「骨は折れていない」と言われたのに、痛みが強くて驚いてしまう。",
    "骨が原因じゃないなら、いったい何が痛いんだろうと、不安になってしまう。",
    "その気持ち、おかしくありません。",
    "実は、痛みの原因は骨だけとは限りません。",
    "筋肉や関節まわりなど、骨以外の組織への負担や炎症が、痛みとして現れることもあります。",
    "骨に異常がないことは、痛みの原因を探る出発点でもあります。",
    "それでも、「じゃあこの痛みは何なのか」と、モヤモヤが残ってしまう。",
    "痛みの原因や感じ方には個人差があり、時間をかけて分かってくることもあります。",
    "気になる症状は、そのまま伝えていただいて大丈夫です。",
    "検査後に痛みが続いて不安になった時、見返せるように保存しておいてください。",
    "次はどんな不安を取り上げるか。フォローして次回もチェックしてみてください。",
]

# Voice-only text avoids symbols that can cause odd reading while preserving meaning.
VOICE_TEXT = [
    "骨は折れていない、と言われたのに、痛みが強くて驚いてしまう。",
    "骨が原因じゃないなら、いったい何が痛いんだろうと、不安になってしまう。",
    "その気持ち、おかしくありません。",
    ...
    "筋肉や関節まわりなど、骨以外の組織への負担や炎症が、痛みとして現れることもあります。",
    "骨に異常がないことは、痛みの原因を探る出発点でもあります。",
    "それでも、じゃあこの痛みは何なのかと、モヤモヤが残ってしまう。",
    "痛みの原因や感じ方には個人差があり、時間をかけて分かってくることもあります。",
    "気になる症状は、そのまま伝えていただいて大丈夫です。",
    "検査後に痛みが続いて不安になった時、見返せるように保存しておいてください。",
    "次はどんな不安を取り上げるか。フォローして次回もチェックしてみてください。",
...
MIN_DURATIONS = [3.7, 5.2, 2.8, 3.2, 6.6, 4.6, 5.0, 5.4, 4.2, 5.2, 4.4]
