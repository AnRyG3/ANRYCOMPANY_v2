...
ASSET_DIR = ROOT / "reel_assets" / "exam_table_support_20260824"
FRAME_DIR = ROOT / "reel_assets" / "exam_table_support_20260824_telop_frames"
AUDIO_DIR = ASSET_DIR / "audio"
WORK_DIR = ASSET_DIR / "_video_work"
VIDEO_DIR = ASSET_DIR / "video"
QA_DIR = ASSET_DIR / "qa_midframes"
MANIFEST = ASSET_DIR / "video_manifest_20260824.json"
...
OUT = VIDEO_DIR / "検査台に上がるのが不安な時_先に伝えてください_20260824.mp4"
...
VOICE_SPEED = 1.2
BGM_VOLUME = "-25dB"
TAIL_PADDING_SECONDS = 0.10

FRAMES = [
    "telop_01_exam_table_hesitation.png",
    "telop_02_table_height_step.png",
    "telop_03_self_pressure_hesitation.png",
    "telop_04_feeling_is_ok.png",
    "telop_05_adjustable_method_explain.png",
    "telop_06_sit_bottom_first_support.png",
    "telop_07_tell_concerns_first.png",
    "telop_08_safe_guidance.png",
    "telop_09_tell_at_table.png",
    "telop_10_save_cta_phone.png",
]

DISPLAY_NARRATION = [
    "「この台、ひとりで上がれるかな」検査台を前にして、立ち止まってしまうことがあります。",
    "高さや段差を見て、不安が先に立ってしまう。",
    "無理をしてでも、自分で上がらなければと、思い込んでしまうことがある。",
    "その気持ち、おかしくありません。",
    "検査台への上がり方は、状態に合わせて調整できます。",
    "多くの場合、まずお尻から座るように上がっていただくと、安定しやすくなります。",
    "不安なことや、いつも気をつけていることを先に伝えていただければ、それに合わせて進め方を調整します。",
    "できるかどうかより、先に伝えていただくことが、安全な検査につながります。",
    "不安なことは、検査台の前でも伝えていただいて大丈夫です。",
    "次の検査前、受付に行く前に見返せるように保存しておいてください。検査室で役立つことを、これからも届けます。フォローしてお待ちください。",
]
