...
ASSET_DIR = ROOT / "reel_assets" / "pediatric_movement_series"
...
OUT = ASSET_DIR / "動いてしまう子どもの検査、実際どうしてるの.mp4"
FINAL_OUT = (
    ROOT
    / "01_ショート動画_リール_YouTubeShorts"
    / "インスタ完成形"
    / "動いてしまう子どもの検査、実際どうしてるの.mp4"
)
...
DISPLAY_NARRATION = [
    "じっとしていられなくて、ちゃんと撮れるか心配です。",
    "大丈夫です。動いてしまうお子さんは、とても多いんです。",
    "小さいお子さんが数秒じっとするのは、実はとても難しいことです。",
    "だからこそ、声のかけ方や撮影のタイミングを工夫しています。",
    "好きな音や声かけで、注意を引くこともあります。",
    "検査によっては、一瞬だけ止まってもらえれば撮れることもあります。",
    "もし動いてしまっても、その場ですぐに確認して対応しています。",
    "またやり直しですか、と気まずく思わなくて大丈夫です。",
    "動いてしまうのは、お子さんが悪いわけでも、保護者の方のせいでもありません。",
    "お子さんのペースに合わせて、無理なく進めていきますね。",
...
VOICEVOX_TEXT = [
    ...
    "大丈夫です。動いてしまうお子さんは、とても多いんです。",
    "小さいお子さんが数秒じっとするのは、実はとても難しいことです。",
    "だからこそ、声のかけかたや撮影のタイミングを工夫しています。",
    "好きな音や声かけで、注意を引くこともあります。",
    "検査によっては、一瞬だけ止まってもらえれば撮れることもあります。",
    "もし動いてしまっても、その場ですぐに確認して対応しています。",
    "またやり直しですか、と気まずく思わなくて大丈夫です。",
    "動いてしまうのは、お子さんが悪いわけでも、保護者のかたのせいでもありません。",
    "お子さんのペースに合わせて、無理なく進めていきますね。",
    "いざという時のために、スマートフォンに保存しておいてくださいね。",
    "しんりょうほうしゃせんぎしの発信、フォローで応援お願いします。",
]

MIN_DURATIONS = [3.8, 4.2, 4.6, 4.8, 4.0, 4.8, 4.2, 4.4, 5.2, 4.0, 4.4, 4.2]
