...
IN_PATH = ROOT / r"02_LINEスタンプ\あんりぃ_LINEスタンプ制作工場\04_完成画像\夏を感じるスタンプ_あんりぃ40\02_提出用候補_06-10\submission_quality_preview_06_10_sheet.png"
OUT_DIR = ROOT / r"02_LINEスタンプ\あんりぃ_LINEスタンプ制作工場\04_完成画像\夏を感じるスタンプ_あんりぃ40\02_提出用候補_06-10\個別PNG"
PREVIEW = OUT_DIR / "preview_submission_06_10_individual.png"

ITEMS = [
    ("06_ice_tabeteyo_submission_candidate.png", (25, 20, 535, 485)),
    ("07_tokeru_submission_candidate.png", (585, 25, 1110, 485)),
    ("08_umi_ikitai_submission_candidate.png", (1130, 20, 1635, 485)),
    ("09_pool_saikou_submission_candidate.png", (320, 495, 825, 925)),
    ("10_hanabi_kirei_submission_candidate.png", (865, 485, 1375, 925)),
]
...
def main() -> None:
    ...
    for name, box in ITEMS:
        crop = sheet.crop(box)
        final = fit_line_canvas(flood_transparent_outer_bg(crop))
