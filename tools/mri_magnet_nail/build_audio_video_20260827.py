...
ASSET_DIR = ROOT / "reel_assets" / "mri_series" / "mri_magnet_nail_20260827"
FRAME_DIR = ASSET_DIR / "telop_frames"
AUDIO_DIR = ASSET_DIR / "audio"
WORK_DIR = ASSET_DIR / "_video_work"
VIDEO_DIR = ASSET_DIR / "video"
QA_DIR = ASSET_DIR / "qa_midframes"
MANIFEST = ASSET_DIR / "video_manifest_20260827.json"
...
OUT = VIDEO_DIR / "MRI前_マグネットネイルしてたらどうする_20260827.mp4"
...
FRAMES = [
    "telop_01_mri_reservation_magnet_nail_patient.png",
    "telop_02_mri_questionnaire_nail_item.png",
    "telop_03_magnet_nail_closeup.png",
    "telop_04_clean_mri_room.png",
    "telop_05_patient_checks_nails_waiting.png",
    "telop_06_rt_checks_patient_nails.png",
    "telop_07_patient_enters_mri_bore_hands_inside.png",
    "telop_08_patient_prepares_nail_removal.png",
    "telop_09_mri_nail_consult_rt.png",
    "telop_10_save_cta_phone.png",
    "telop_11_rt_closing_mri_corridor.png",
]

DISPLAY_NARRATION = [
    "MRIの予約があるのに、マグネットネイルをしている。これ、外した方がいいのかなと思う方がいます。",
    "MRI検査前の問診で、ネイルについて聞かれて驚くことがあります。",
    "マグネットネイルや一部のジェルネイルには、鉄粉などの金属成分が含まれることがあります。",
    "MRIは、強い磁石と電波を使って撮影する検査です。",
    "成分によっては、熱を持ったり、変色したり、画像に影響したりする可能性があります。",
    "特に大事なのは、画像だけでなく、患者さんの体へのリスクがあることです。",
    "撮影する場所が手元から離れていても、MRI装置の中には入ります。",
    "施設によって対応は分かれますが、予約検査なら、前もって準備できると安心です。",
    "外せない場合や、対象かわからない場合は、予約時や検査前に相談してください。",
    "MRI予約がある人や家族は、検査前日や受付前に見返せるように保存しておいてください。",
    "検査前の疑問も、診療放射線技師目線でやさしく発信しています。",
]

VOICE_TEXT = [
    "エムアールアイの予約があるのに、マグネットネイルをしている。これ、外したほうがいいのかなと思うかたがいます。",
    "エムアールアイ検査前の問診で、ネイルについて聞かれて驚くことがあります。",
    "マグネットネイルや一部のジェルネイルには、てっぷんなどの金属成分が含まれることがあります。",
    "エムアールアイは、強い磁石と電波を使って撮影する検査です。",
    "成分によっては、熱を持ったり、変色したり、画像に影響したりする可能性があります。",
    "特に大事なのは、画像だけでなく、患者さんの体へのリスクがあることです。",
    "撮影する場所が手元から離れていても、エムアールアイ装置の中には入ります。",
    "施設によって対応は分かれますが、予約検査なら、前もって準備できると安心です。",
    "外せない場合や、対象かわからない場合は、予約時や検査前に相談してください。",
    "エムアールアイ予約がある人や家族は、検査前日や受付前に見返せるように保存しておいてください。",
    "検査前の疑問も、しんりょうほうしゃせんぎし目線で、やさしく発信しています。",
]
