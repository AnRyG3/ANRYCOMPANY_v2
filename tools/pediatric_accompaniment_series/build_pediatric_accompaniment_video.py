...
ASSET_DIR = ROOT / "reel_assets" / "pediatric_accompaniment_series"
...
OUT = ASSET_DIR / "抱っこして付き添っても大丈夫.mp4"
FINAL_OUT = (
    ROOT
    / "01_ショート動画_リール_YouTubeShorts"
    / "インスタ完成形"
...
FRAMES = [
    "01_parent_child_anxious_telop.png",
    "02_tech_explains_telop.png",
    "03_child_restless_telop.png",
    "04_parent_reassures_child_telop.png",
    "05_protective_apron_telop.png",
    "06_parent_wearing_apron_telop.png",
    "07_position_guidance_telop.png",
    "08_parent_confirms_telop.png",
    "09_child_calm_telop.png",
    "10_tech_consult_telop.png",
    "11_save_cta_telop.png",
    "12_follow_cta_telop.png",
]

DISPLAY_NARRATION = [
    "検査中、ずっと泣いていて。抱っこしたままじゃダメですか。",
    "検査内容にもよりますが、抱っこしたまま付き添っていただくこともあります。",
    "小さいお子さんは、一人でじっとしているのが難しいことも多いんです。",
    "そんな時は、保護者の方が近くにいる方が、お子さんも安心できます。",
    "付き添っていただく際は、防護用のエプロンを着けていただきます。",
    "必要のない被ばくを、できるだけ少なくしながら付き添えます。",
    "抱き方や立ち位置は、診療放射線技師がその場でご案内します。",
    "これで合っていますか、と聞いていただいて大丈夫です。",
    "そばにいてあげる方が、検査がスムーズに進むこともあります。",
    "不安なまま検査を受けさせるより、まずは相談してみてください。",
    "役に立ったら保存して、あとで見返してください。",
...
VOICEVOX_TEXT = [
    ...
    "検査内容にもよりますが、抱っこしたまま付き添っていただくこともあります。",
    "小さいお子さんは、一人でじっとしているのが難しいことも多いんです。",
    "そんな時は、保護者のかたが近くにいるほうが、お子さんも安心できます。",
    "付き添っていただく際は、防護用のエプロンを着けていただきます。",
    "必要のない被ばくを、できるだけ少なくしながら付き添えます。",
    "だきかたや立ち位置は、しんりょうほうしゃせんぎしが、その場でご案内します。",
    "これで合っていますか、と聞いていただいて大丈夫です。",
    "そばにいてあげるほうが、検査がスムーズに進むこともあります。",
    "不安なまま検査を受けさせるより、まずは相談してみてください。",
    "役に立ったら保存して、あとで見返してください。",
    "しんりょうほうしゃせんぎしの発信、フォローして応援してもらえると嬉しいです。",
]

MIN_DURATIONS = [4.6, 5.2, 4.6, 4.8, 4.4, 4.2, 4.6, 3.8, 4.8, 4.6, 3.8, 5.0]
