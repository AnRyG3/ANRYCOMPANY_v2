...
ASSET_DIR = (
    ROOT
    / "reel_assets"
    / "pediatric_accompaniment_series"
    / "crying_child_no_force"
)
FRAME_DIR = ASSET_DIR / "telop_frames_short"
...
OUT = ASSET_DIR / "泣いている子、無理やり撮影するの.mp4"
FINAL_OUT = (
    ROOT
    / "01_ショート動画_リール_YouTubeShorts"
    / "インスタ完成形"
    / "泣いている子、無理やり撮影するの.mp4"
)
...
FRAMES = [
    "01_parent_child_corridor_telop.png",
    "02_rt_explains_telop.png",
    "03_child_nervous_telop.png",
    "04_child_pov_xray_room_telop.png",
    "05_rt_gentle_voice_telop.png",
    "06_child_calming_telop.png",
    "07_consult_options_telop.png",
    "08_parent_relieved_telop.png",
    "09_parent_child_close_telop.png",
    "10_rt_reassuring_telop.png",
    "11_save_cta_telop.png",
    "12_follow_cta_telop.png",
]

DISPLAY_NARRATION = [
    "あんなに泣いているのに、このまま撮影するんですか。",
    "大丈夫です。無理やり押さえつけて撮ることはありません。",
    "お子さんが泣いているのには、ちゃんと理由があります。",
    "知らない場所、知らない機械、知らない人。怖くて当然なんです。",
    "少し落ち着くのを待ったり、声のかけ方を変えたりしながら進めています。",
    "泣いていても、短い撮影なら上手に撮れることもあります。",
    "どうしても難しい時は、無理をせず、別の進め方を相談することもあります。",
    "泣かせてしまってごめんなさい、と謝らなくて大丈夫です。",
    "泣くのは、お子さんが不安を伝えてくれているサインでもあります。",
    "焦らず、お子さんのペースに合わせて進めていきますね。",
    "いざという時のために、スマートフォンに保存しておいてくださいね。",
...
VOICEVOX_TEXT = [
    ...
    "お子さんが泣いているのには、ちゃんと理由があります。",
    "知らない場所、知らない機械、知らない人。怖くて当然なんです。",
    "少し落ち着くのを待ったり、声のかけかたを変えたりしながら進めています。",
    "泣いていても、短い撮影なら上手に撮れることもあります。",
    "どうしても難しい時は、無理をせず、別の進めかたを相談することもあります。",
    "泣かせてしまってごめんなさい、と謝らなくて大丈夫です。",
    "泣くのは、お子さんが不安を伝えてくれているサインでもあります。",
    "焦らず、お子さんのペースに合わせて進めていきますね。",
    "いざという時のために、スマートフォンに保存しておいてくださいね。",
...
MIN_DURATIONS = [3.8, 4.2, 3.8, 4.6, 5.0, 4.4, 5.2, 4.2, 4.6, 4.0, 4.2, 4.4]
