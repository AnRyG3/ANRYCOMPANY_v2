...
ASSET_DIR = ROOT / "reel_assets" / "mri_series" / "mri_makeup_20260828"
FRAME_DIR = ROOT / "reel_assets" / "mri_series" / "mri_makeup_20260828_telop_frames"
AUDIO_DIR = ASSET_DIR / "audio"
WORK_DIR = ASSET_DIR / "_video_work"
VIDEO_DIR = ASSET_DIR / "video"
QA_DIR = ASSET_DIR / "qa_midframes"
MANIFEST = ASSET_DIR / "video_manifest_20260828.json"
...
OUT = VIDEO_DIR / "MRI前_メイクして行っても大丈夫ですか_20260828.mp4"
...
FRAMES = [
    "telop_01_opening_makeup_question.png",
    "telop_02_eye_makeup_pause.png",
    "telop_03_appointment_prep_still_life.png",
    "telop_04_eye_makeup_items.png",
    "telop_05_bright_mri_room.png",
    "telop_06_head_coil_prep.png",
    "telop_07_reassured_patient_phone.png",
    "telop_08_reception_makeup_confirm.png",
    "telop_09_save_cta_before_appointment.png",
    "telop_10_rt_closing.png",
]

DISPLAY_NARRATION = [
    "MRIの日、メイクってして行っても大丈夫ですか。",
    "MRI検査前に、メイクについて確認されることがあります。",
    "特にアイシャドウ、アイライナー、マスカラなどのアイメイクは注意されることがあります。",
    "化粧品の中には、金属成分が含まれているものがあるためです。",
    "MRIでは、金属成分が熱感や画像の乱れにつながる可能性があります。",
    "特に頭部や顔まわりの検査では、メイクを控えめにするよう案内されることがあります。",
    "ただし、すべてのメイクが必ずダメという意味ではありません。",
    "施設や検査部位によって対応が変わるため、不安なときは予約の時や受付で、メイクをしていますと伝えてください。",
    "MRIの予約がある人は、検査前日や受付前に見返せるように保存しておいてください。",
    "ほかの検査前の疑問も、診療放射線技師目線で発信しています。",
]

VOICE_TEXT = [
    "エムアールアイの日、メイクってして行っても大丈夫ですか。",
    "エムアールアイ検査前に、メイクについて確認されることがあります。",
    "特にアイシャドウ、アイライナー、マスカラなどのアイメイクは注意されることがあります。",
    "化粧品の中には、金属成分が含まれているものがあるためです。",
    "エムアールアイでは、金属成分が熱感や画像の乱れにつながる可能性があります。",
    "特に頭部や顔まわりの検査では、メイクを控えめにするよう案内されることがあります。",
    "ただし、すべてのメイクが必ずダメという意味ではありません。",
    "施設や検査部位によって対応が変わるため、不安なときは予約の時や受付で、メイクをしていますと伝えてください。",
    "エムアールアイの予約がある人は、検査前日や受付前に見返せるように保存しておいてください。",
    "ほかの検査前の疑問も、しんりょうほうしゃせんぎし目線で発信しています。",
]
...
def make_qa_contact_sheet(paths: list[Path], output: Path) -> None:
    ...
    label_font = ImageDraw.ImageFont.load_default() if hasattr(ImageDraw, "ImageFont") else None
