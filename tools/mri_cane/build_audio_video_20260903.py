...
ASSET_DIR = ROOT / "reel_assets" / "mri_series" / "mri_cane_20260903"
FRAME_DIR = ROOT / "reel_assets" / "mri_series" / "mri_cane_20260903_telop_frames"
AUDIO_DIR = ASSET_DIR / "audio"
WORK_DIR = ASSET_DIR / "_video_work"
VIDEO_DIR = ASSET_DIR / "video"
FINAL_DIR = ROOT / "01_ショート動画_リール_YouTubeShorts" / "インスタ完成形"
QA_DIR = ASSET_DIR / "qa_midframes"
MANIFEST = ASSET_DIR / "video_manifest_20260903.json"
...
TITLE = "杖を使っていてもMRI検査は受けられます_20260903"
OUT = VIDEO_DIR / f"{TITLE}.mp4"
FINAL_OUT = FINAL_DIR / OUT.name

FRAMES = [
    "telop_01_hook_home_cane.png",
    "telop_02_reception_tell_cane.png",
    "telop_03_cane_outside_mri_room.png",
    "telop_04_supported_walk_mri.png",
    "telop_05_positioning_on_table.png",
    "telop_06_calm_on_mri_table.png",
    "telop_07_after_exam_sit_up.png",
    "telop_08_receive_cane_after_mri.png",
    "telop_09_prepare_to_tell_cane.png",
    "telop_10_save_cta_phone.png",
]

DISPLAY_NARRATION = [
    "杖がないと歩けないけど、MRIって大丈夫かな。",
    "杖を使っている方も、MRI検査は受けられます。",
    "ただし、杖をMRI室の中に持ち込むことはできません。",
    "寝台までは、スタッフが支えながらご案内します。",
    "横になったら、体の位置を整えて検査の準備をします。",
    "体勢が整ったら、そのまま検査へ進みます。",
    "検査後も、起き上がりやふらつきがないか確認します。",
    "杖の場所まで、同じようにご案内します。",
    "杖が手放せない方は、予約時に伝えておくとスムーズです。",
    "ご本人やご家族が検査前日に見返せるよう、この投稿を保存してください。",
]

VOICE_TEXT = [
    "杖がないと歩けないけど、エムアールアイって大丈夫かな。",
    "杖を使っているかたも、エムアールアイ検査は受けられます。",
    "ただし、杖をエムアールアイ室の中に持ち込むことはできません。",
    "寝台までは、スタッフが支えながらご案内します。",
    "横になったら、体の位置を整えて検査の準備をします。",
    "体勢が整ったら、そのまま検査へ進みます。",
    "検査後も、起き上がりやふらつきがないか確認します。",
    "杖の場所まで、同じようにご案内します。",
    "杖が手放せないかたは、予約時に伝えておくとスムーズです。",
    "ご本人やご家族が検査前日に見返せるよう、この投稿を保存してください。",
]
