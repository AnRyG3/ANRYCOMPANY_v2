...
ASSET_DIR = ROOT / "reel_assets" / "mri_series" / "mri_color_contact_20260828"
FRAME_DIR = ROOT / "reel_assets" / "mri_series" / "mri_color_contact_20260828_telop_frames"
...
OUT = VIDEO_DIR / "MRI前_カラコンは外す_20260828.mp4"
...
FRAMES = [
    "telop_01_patient_contact_case.png",
    "telop_02_patient_checks_appointment.png",
    "telop_03_rt_clear_contact_explain.png",
    "telop_04_colored_contact_still_life.png",
    "telop_05_mri_precheck_counter.png",
    "telop_06_mri_contact_risk_calm.png",
    "telop_07_patient_removes_contacts.png",
    "telop_08_patient_consults_rt.png",
    "telop_09_save_cta_phone.png",
    "telop_10_rt_closing.png",
]

DISPLAY_NARRATION = [
    "MRI前日、カラコンって外して行くべきですか。",
    "MRI検査前の問診で、コンタクトについて聞かれて驚く方がいます。",
    "透明なコンタクトは、そのまま検査できる施設もあります。",
    "一方でカラーコンタクトや縁取りのあるレンズは、着色部分に金属成分が含まれていることがあります。",
    "MRIは、強い磁場と電波を使って撮影する検査です。",
    "金属成分が、発熱や画像への影響につながることがあります。",
    "そのため、カラーコンタクトは外すよう案内されることがあります。",
    "迷ったときは、予約の時や受付で、カラコンをしていますと伝えて大丈夫です。",
    "MRIの予約がある人は、前日や受付前に見返せるように、この投稿を保存しておいてください。",
    "ほかの検査前の疑問も、診療放射線技師目線で発信しています。",
]

VOICE_TEXT = [
    "エムアールアイ前日、カラコンって外して行くべきですか。",
    "エムアールアイ検査前の問診で、コンタクトについて聞かれて驚くかたがいます。",
    "透明なコンタクトは、そのまま検査できる施設もあります。",
    "一方でカラーコンタクトやふちどりのあるレンズは、着色部分に金属成分が含まれていることがあります。",
    "エムアールアイは、強い磁場と電波を使って撮影する検査です。",
    "金属成分が、発熱や画像への影響につながることがあります。",
    "そのため、カラーコンタクトは外すよう案内されることがあります。",
    "迷ったときは、予約の時や受付で、カラコンをしていますと伝えて大丈夫です。",
    "エムアールアイの予約がある人は、前日や受付前に見返せるように、この投稿を保存しておいてください。",
