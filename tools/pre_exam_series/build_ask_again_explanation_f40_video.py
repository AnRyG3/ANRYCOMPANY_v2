...
DISPLAY_NARRATION = [
    ...
    "「今さら聞き返すのも、恥ずかしいな」と、黙ってしまった。",
    "でも、説明は一度で全部理解できなくても大丈夫です。",
    "専門的な言葉が多くて、わかりにくいのは自然なことです。",
    "「もう一度お願いします」と、言っていただいて構いません。",
    "わかったふりをするより、聞き返してもらう方が確認しやすくなります。",
    "診療放射線技師も、必要なところからもう一度説明します。",
    "聞き返すことは、決しておかしなことではありません。",
    "不安になった時のために、保存して検査前に見返してください。",
...
VOICEVOX_TEXT = [
    ...
    "もう一度お願いします、と、言っていただいて構いません。",
    "わかったふりをするより、聞き返してもらう方が確認しやすくなります。",
    "しんりょうほうしゃせんぎしも、必要なところからもう一度説明します。",
    "聞き返すことは、決しておかしなことではありません。",
    "不安になった時のために、保存して検査前に見返してください。",
    "フォローして、検査への不安を一緒に減らしていきましょう。",
]

MIN_DURATIONS = [3.0, 3.2, 3.3, 3.4, 3.2, 4.0, 4.0, 3.2, 4.0, 3.8]
