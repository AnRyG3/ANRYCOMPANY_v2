...
ASSET_DIR = ROOT / "reel_assets" / "pre_exam_series" / "13_exam_gown_cold_towel_blanket"
...
TITLE = "検査着が寒い_タオルケットをお願いしていい_20260917"
OUT = VIDEO_DIR / f"{TITLE}.mp4"
FINAL_OUT = FINAL_DIR / OUT.name
MANIFEST = ASSET_DIR / "video_manifest.json"

FRAMES = [
    "01_waiting_cold_telop.png",
    "02_hesitating_telop.png",
    "03_speaking_up_telop.png",
    "04_exam_gown_light_telop.png",
    "05_towel_blanket_option_telop.png",
    "06_ask_technologist_telop.png",
    "07_staff_confirms_telop.png",
    "08_lap_blanket_telop.png",
    "09_relief_telop.png",
    "10_save_cta_telop.png",
    "11_follow_cta_telop.png",
]

# Display text and narration are kept separately so the spoken pacing stays natural.
DISPLAY_NARRATION = [
    "検査着、思ったより寒い。",
    "これくらいで言っていいのかな。",
    "寒いときは、スタッフに伝えて大丈夫です。",
    "検査着は、普段着より肌寒く感じることがあります。",
    "施設や検査によっては、タオルケットで対応できることもあります。",
    "タオルケットをお借りできますか。ひとことで大丈夫です。",
    "使えるものは、スタッフが確認します。",
    "検査前の小さなことも、遠慮なく相談してください。",
    "寒さを我慢しなくて大丈夫です。",
...
def main() -> None:
    ...
    qa = {
        ...
        "duration_strategy": "each image remains through its matching voice, plus only 0.12 seconds; no fixed long silent pause",
    }
    manifest = {
        "title": TITLE,
