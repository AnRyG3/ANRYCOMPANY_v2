...
INPUT_DIR = ROOT / "reel_assets" / "pre_exam_series" / "11_wig_hairpowder_ct_mri_images"
OUTPUT_DIR = ROOT / "reel_assets" / "pre_exam_series" / "11_wig_hairpowder_ct_mri_telop"
...
FRAMES = [
    {
        "src": "frame_01_home_wig_check.png",
        "out": "telop_01_home_wig_check.png",
        "segments": [[("ウィッグ", "blue"), "のまま"], [("CT", "blue"), "や", ("MRI", "blue"), "、受けられる？"]],
        "position": "top",
    },
    {
        "src": "frame_02_reception_consult.png",
        "out": "telop_02_reception_consult.png",
        "segments": [[("MRI", "blue"), "検査では"], ["ウィッグは外します"]],
        "position": "top",
    },
    {
        "src": "frame_03_head_ct_with_wig.png",
        "out": "telop_03_head_ct_with_wig.png",
        "segments": [[("当院", "blue"), "では", ("頭部CT", "blue"), "は"], ["つけたままでも対応しています"]],
        "position": "bottom",
    },
    {
        "src": "frame_04_facility_policy_explanation.png",
        "out": "telop_04_facility_policy_explanation.png",
        "segments": [["対応は"], [("病院によって", "blue"), "異なります"]],
        "position": "bottom",
    },
    {
        "src": "frame_05_hair_powder_check.png",
        "out": "telop_05_hair_powder_check.png",
        "segments": [[("増毛パウダー", "blue"), "も"], ["検査前に一言を"]],
        "position": "top",
    },
    {
        "src": "frame_06_mri_room_no_door.png",
        "out": "telop_06_mri_room_no_door.png",
        "segments": [[("MRI", "blue"), "は"], [("CT", "blue"), "とはルールが違います"]],
        "position": "bottom",
    },
    {
        "src": "frame_07_wig_storage_privacy.png",
        "out": "telop_07_wig_storage_privacy.png",
        "segments": [["外した後の", ("置き場所", "blue"), "も"], ["配慮しています"]],
        "position": "bottom",
    },
    {
        "src": "frame_08_after_exam_wig_back_on.png",
        "out": "telop_08_after_exam_wig_back_on.png",
        "segments": [["終わったら"], [("すぐ", "blue"), "つけ直せます"]],
        "position": "bottom",
    },
    {
        "src": "frame_09_appointment_memo.png",
        "out": "telop_09_appointment_memo.png",
        "segments": [["予約時や受付で"], [("一言", "blue"), "伝えると安心です"]],
        "position": "center",
    },
    {
        "src": "frame_10_save_cta_phone.png",
        "out": "telop_10_save_cta_phone.png",
        "segments": [["検査前日・受付前に"], [("保存", "save"), "して見返してください"]],
        "position": "top",
    },
]
...
def main() -> None:
    ...
    MANIFEST.write_text(
        json.dumps(
            {
                "title": "かつら・ウィッグ・増毛パウダーとCT/MRI",
                "style": "要点だけ、1画面1メッセージ、X軸中央、上・中央・下のみ、可能な限り中央配置、重要語だけ青強調",
                "font": str(FONT_PATH),
