...
ASSET_DIR = ROOT / "reel_assets" / "pre_exam_series" / "11_wig_hairpowder_ct_mri"
FRAME_DIR = ROOT / "reel_assets" / "pre_exam_series" / "11_wig_hairpowder_ct_mri_telop"
AUDIO_DIR = ASSET_DIR / "audio"
WORK_DIR = ASSET_DIR / "_video_work"
VIDEO_DIR = ASSET_DIR / "video"
FINAL_DIR = ROOT / "01_ショート動画_リール_YouTubeShorts" / "インスタ完成形"
MANIFEST = ASSET_DIR / "video_manifest_20260904.json"
MIDFRAME_SHEET = ASSET_DIR / "video_qa_midframes_20260904.png"
...
TITLE = "かつらウィッグ増毛パウダー_CT_MRI検査_20260904"
OUT = VIDEO_DIR / f"{TITLE}.mp4"
FINAL_OUT = FINAL_DIR / OUT.name

FRAMES = [
    "telop_01_home_wig_check.png",
    "telop_02_reception_consult.png",
    "telop_03_head_ct_with_wig.png",
    "telop_04_facility_policy_explanation.png",
    "telop_05_hair_powder_check.png",
    "telop_06_mri_room_no_door.png",
    "telop_07_wig_storage_privacy.png",
    "telop_08_after_exam_wig_back_on.png",
    "telop_09_appointment_memo.png",
    "telop_10_save_cta_phone.png",
]

DISPLAY_NARRATION = [
    "ウィッグのまま、CTやMRIって受けられるのかな。そんな不安、ありますよね。",
    "MRI検査では、安全のため、かつらやウィッグを外していただきます。",
    "当院では、頭部CTは、つけたままでも対応しています。",
    "ただし対応は、病院によって異なります。他院では外す案内になることもあります。",
    "増毛パウダーを使っている方も、検査前に一言伝えておくと安心です。",
    "MRIは、CTとは違うルールになります。",
    "外した後の置き場所も、できるだけ配慮して対応しています。",
    "検査が終わったら、すぐにつけ直していただけます。",
    "不安な方は、予約のときや受付で、一言伝えておくと安心です。",
    "検査前日や受付前に見返せるよう、保存しておいてください。",
]

VOICE_TEXT = [
    "ウィッグのまま、シーティーやエムアールアイって受けられるのかな。そんな不安、ありますよね。",
    "エムアールアイ検査では、安全のため、かつらやウィッグを外していただきます。",
    "当院では、頭部シーティーは、つけたままでも対応しています。",
    "ただし対応は、病院によって異なります。他院では外す案内になることもあります。",
    "ぞうもうパウダーを使っているかたも、検査前に一言伝えておくと安心です。",
    "エムアールアイは、シーティーとは違うルールになります。",
    "外した後の置き場所も、できるだけ配慮して対応しています。",
    "検査が終わったら、すぐにつけ直していただけます。",
    "不安なかたは、予約のときや受付で、一言伝えておくと安心です。",
    "検査前日や受付前に見返せるよう、保存しておいてください。",
]
...
def make_midframe_sheet(video: Path, durations: list[float]) -> None:
    ...
    for idx, (path, timestamp) in enumerate(thumbs):
        ...
        draw.text((x + 8, y + thumb_h + 8), f"{idx + 1:02d} {timestamp:.1f}s", font=label_font, fill=(12, 34, 64))
...
def main() -> None:
    ...
    manifest = {
        ...
        "sync_check": "Each still frame duration is matched to its narration segment plus 0.10 seconds only; no long silent gap is inserted.",
    }
