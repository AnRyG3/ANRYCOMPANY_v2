...
ASSET_DIR = ROOT / "reel_assets" / "parent_exam_waiting_place_09_production"
FRAME_DIR = ROOT / "reel_assets" / "parent_exam_waiting_place_09_telop_frames"
...
TITLE = "親の検査当日_付き添い家族が待つ場所"
OUT = VIDEO_DIR / f"{TITLE}.mp4"
FINAL_OUT = FINAL_DIR / OUT.name

FRAMES = [
    "frame_01_companion_unsure_corridor_telop.png",
    "frame_02_signs_unclear_corridor_telop.png",
    "frame_03_reassurance_waiting_telop.png",
    "frame_04_near_exam_room_waiting_telop.png",
    "frame_05_separate_waiting_area_telop.png",
    "frame_06_check_reception_telop.png",
    "frame_07_call_guidance_board_telop.png",
    "frame_08_listening_for_call_telop.png",
    "frame_09_ask_on_spot_telop.png",
    "frame_10_cta_save_review_telop.png",
]

DISPLAY_NARRATION = [
    "親の検査当日、「ここで待っていればいいのかな」と迷ってしまうことがあります。",
    "検査室の前で待つのか、待合スペースに戻るのか、分かりづらいことがあります。",
    "その気持ち、おかしくありません。",
    "待つ場所は、検査の種類や病院の造りによって異なります。",
    "検査室の近くで待つ場合もあれば、離れた待合スペースをご案内する場合もあります。",
    "分からないときは、受付やスタッフに確認していただければ大丈夫です。",
    "検査後の呼び出し方法も、施設ごとに案内があります。",
    "それでも、「呼ばれるのを聞き逃さないかな」と気になることもあります。",
    "迷ったときは、その場で聞いてください。それが一番確実です。",
    "親の検査に付き添う前に見返せるよう、保存しておいてください。家族の検査で迷わないために、フォローもどうぞ。",
]
...
MIN_DURATIONS = [4.1, 4.6, 2.6, 3.8, 5.4, 4.2, 3.8, 4.2, 3.8, 6.1]
