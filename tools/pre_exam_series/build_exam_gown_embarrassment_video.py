...
FRAMES = [
    "frame_01_patient_gown_hesitant_telop.png",
    "frame_02_patient_self_conscious_sleeve_telop.png",
    "frame_03_patient_natural_resistance_telop.png",
    "frame_04_patient_checks_gown_fabric_telop.png",
    "frame_05_patient_corridor_reserved_telop.png",
    "frame_06_rt_reassures_patient_telop.png",
    "frame_07_patient_relief_after_talking_telop.png",
    "frame_08_patient_relaxed_corridor_telop.png",
    "frame_09_save_cta_background_telop.png",
    "frame_10_follow_cta_rt_tech_telop.png",
]

DISPLAY_NARRATION = [
    "検査着に着替えるの、少し恥ずかしい。",
    "こんなことで気にするの、変かな。そう感じる人もいます。",
    "検査着に抵抗を感じるのは、自然なことです。",
    "透けないかな、体のラインが気になる。そんな不安もありますよね。",
    "担当するスタッフの性別が気になることも、珍しくありません。",
...
# Voice-only reading text. Keep punctuation for natural pauses.
VOICEVOX_TEXT = [
    "検査着に着替えるの、少し恥ずかしい。",
    "こんなことで気にするの、変かな。そう感じる人もいます。",
    "検査着に抵抗を感じるのは、自然なことです。",
...
MIN_DURATIONS = [3.0, 3.4, 3.2, 4.0, 3.8, 4.4, 3.6, 3.2, 3.6, 3.8]
