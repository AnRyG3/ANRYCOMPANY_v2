...
ASSET_DIR = ROOT / "reel_assets" / "mri_series" / "mri_tattoo_artmakeup_20260905"
FRAME_DIR = ROOT / "reel_assets" / "mri_series" / "mri_tattoo_artmakeup_20260905_telop"
AUDIO_DIR = ASSET_DIR / "audio"
WORK_DIR = ASSET_DIR / "_video_work"
VIDEO_DIR = ASSET_DIR / "video"
FINAL_DIR = ROOT / "01_ショート動画_リール_YouTubeShorts" / "インスタ完成形"
MANIFEST = ASSET_DIR / "video_manifest_20260905.json"
MIDFRAME_SHEET = ASSET_DIR / "video_qa_midframes_20260905.png"
...
TITLE = "MRI前_タトゥーアートメイク申告_20260905"
OUT = VIDEO_DIR / f"{TITLE}.mp4"
FINAL_OUT = FINAL_DIR / OUT.name

FRAMES = [
    "telop_01_reception_disclose_tattoo.png",
    "telop_02_waiting_area_worry.png",
    "telop_03_tattoo_checklist_closeup.png",
    "telop_04_artmakeup_eye_closeup.png",
    "telop_05_pigment_checklist_stilllife.png",
    "telop_06_staff_hand_screening.png",
    "telop_07_mri_room_15t_background.png",
    "telop_08_patient_relieved.png",
    "telop_09_save_share_cta_background.png",
]

DISPLAY_NARRATION = [
    "タトゥーがあるけど、MRIって受けられるのかな。",
    "そんなときは、受付前に先に一言、伝えてください。",
    "色素の成分は、見た目だけでは分からないことがあります。",
    "アートメイクや入れ墨も、検査前の確認が必要です。",
    "検査中に熱く感じることがあるため、事前の申告が大切です。",
    "伝えてもらえれば、スタッフが検査の条件を確認できます。",
    "当院では、タトゥーや入れ墨のある方は、3Tでは撮像せず、1.5Tで対応しています。",
    "隠さなくて大丈夫です。言っていいことなんです。",
    "検査前日や受付前に見返せるよう、保存しておいてください。",
]

VOICE_TEXT = [
    "タトゥーがあるけど、エムアールアイって受けられるのかな。",
    "そんなときは、受付前に先に一言、伝えてください。",
    "色素の成分は、見た目だけでは分からないことがあります。",
    "アートメイクや、入れ墨も、検査前の確認が必要です。",
    "検査中に熱く感じることがあるため、事前の申告が大切です。",
    "伝えてもらえれば、スタッフが検査の条件を確認できます。",
    "当院では、タトゥーや入れ墨のあるかたは、さんてすらでは撮像せず、いってんごテスラで対応しています。",
    "隠さなくて大丈夫です。言っていいことなんです。",
    "検査前日や受付前に見返せるよう、保存しておいてください。",
]
...
def main() -> None:
    ...
    manifest = {
        ...
        "sync_check": "Each still frame duration is matched to its narration segment plus 0.06 seconds only; no long silent gap is inserted.",
    }
