...
def main():
    ...
    center(draw, (90, 250, 900, 80), "あなたはどっち？", font(42), navy)
    center(draw, (80, 360, 920, 240), "CTとMRI\nどっちが不安？", font(74), navy)
    ...
    center(draw, (200, 1060, 680, 180), "コメントで\n教えてください", font(54), navy)
    draw.line((300, 1240, 780, 1240), fill=yellow, width=18)

    center(draw, (120, 1540, 840, 70), "気軽に参加してください", font(44), "#334155")
    center(draw, (120, 1648, 840, 48), "※個別の医療相談は医療機関へ", font(28, False), "#64748b")
