...
ASSET_DIR = ROOT / "reel_assets" / "contrast_ct_water_after_exam"
FRAME_DIR = ROOT / "reel_assets" / "contrast_ct_water_after_exam_telop_frames"
...
OUT = VIDEO_DIR / "造影剤の検査後_水分をとるように言われる理由.mp4"
...
FRAMES = [
    "frame_01_opening_patient_water_telop.png",
    "frame_02_rt_explains_water_telop.png",
    "frame_03_patient_reassured_telop.png",
    "frame_04_rt_ct_explanation_telop.png",
    "frame_05_patient_drinks_water_telop.png",
    "frame_06_more_water_explanation_telop.png",
    "frame_07_usual_hydration_telop.png",
    "frame_08_mild_concern_telop.png",
    "frame_09_reassuring_close_telop.png",
    "frame_10_cta_end_card_telop.png",
]

DISPLAY_NARRATION = [
    "検査が終わったあと、看護師さんにも、医師にも、診療放射線技師にも、「水分をとってくださいね」と言われる。",
    "何度も言われると、逆に「そんなに大事なの？」と気になることがあります。",
    "その気持ち、おかしくありません。",
    "実は、検査で使った造影剤は、時間をかけて、主に尿としてからだの外に出ていきます。",
    "水分をとることで、その排出を助けることにつながります。",
    "そのため、検査後は、いつもより少し多めに水分をとっていただくようお願いしています。",
    "特別なことをするわけではなく、普段の水分補給を少し意識していただくだけで大丈夫です。",
    "それでも、「何度も言われると、逆に不安になる」と感じることもあります。",
    "繰り返しお伝えするのは、それだけ大切なことだからです。それだけで危険という意味ではありません。",
...
VOICE_TEXT = [
    ...
    "実は、検査で使った造影剤は、時間をかけて、主に尿としてからだの外に出ていきます。",
    "水分をとることで、その排出を助けることにつながります。",
    "そのため、検査後は、いつもより少し多めに、水分をとっていただくようお願いしています。",
    "特別なことをするわけではなく、普段の水分補給を少し意識していただくだけで大丈夫です。",
    "それでも、何度も言われると、逆に不安になる。と感じることもあります。",
    "繰り返しお伝えするのは、それだけ大切なことだからです。それだけで危険という意味ではありません。",
    "造影検査のあとに見返せるように、保存しておいてください。",
...
MIN_DURATIONS = [5.0, 4.2, 2.8, 5.4, 3.8, 5.0, 5.2, 4.8, 6.0, 4.2]
