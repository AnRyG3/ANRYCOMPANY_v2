...
DIR = ROOT / "02_LINEスタンプ" / "あんりぃ_LINEスタンプ制作工場" / "04_完成画像" / "敬語・仕事返信スタンプ_あんりぃ40" / "04_再設計09-16"
ASSET_DIR = DIR / "生成素材"
FONT = Path(r"C:\Windows\Fonts\meiryob.ttc")
BROWN = (92, 60, 48, 255)

SAMPLES = [
    ("09", "おはよう\nございます", "09_ohayou_chroma.png", (42, 91, 150, 255)),
    ("10", "お先に\n失礼します", "10_osakini_chroma.png", (121, 82, 65, 255)),
    ("11", "お願いします", "11_onegaishimasu_chroma.png", (121, 82, 65, 255)),
    ("12", "かしこまり\nました", "12_kashikomarimashita_chroma.png", (42, 91, 150, 255)),
    ("13", "問題\nありません", "13_mondai_arimasen_chroma.png", (47, 120, 92, 255)),
    ("14", "大丈夫です", "14_daijoubu_chroma.png", (47, 120, 92, 255)),
    ("15", "対応します", "15_taiou_chroma.png", (42, 91, 150, 255)),
    ("16", "確認しました", "16_kakuninshimashita_chroma.png", (47, 120, 92, 255)),
]
...
def main() -> None:
    ...
    preview.convert("RGB").save(DIR / "preview_keigo_redesign_09_16.png", quality=95)
    print("created=8")
